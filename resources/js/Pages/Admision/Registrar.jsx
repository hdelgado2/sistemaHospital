              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setData("etnia_religion", e.target.value)}
                    className="mt-1 block w-full border-gray-300 dark:border-slate-700 dark:bg-slate-800 dark:text-white rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 p-2 border"
                  />
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setData("entidad_aseguradora", e.target.value)}
                    className="mt-1 block w-full border-gray-300 dark:border-slate-700 dark:bg-slate-800 dark:text-white rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 p-2 border"
                  />
                </div>
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => setData("tipo_plan", e.target.value)}
                    className="mt-1 block w-full border-gray-300 dark:border-slate-700 dark:bg-slate-800 dark:text-white rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 p-2 border"
                  >
                    <option value="">Seleccione</option>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setData("responsable_parentesco", e.target.value)}
                    className="mt-1 block w-full border-gray-300 dark:border-slate-700 dark:bg-slate-800 dark:text-white rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 p-2 border"
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setData("responsable_telefono", e.target.value)}
                    className="mt-1 block w-full border-gray-300 dark:border-slate-700 dark:bg-slate-800 dark:text-white rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 p-2 border"
                  />
                </div>
              </div>
